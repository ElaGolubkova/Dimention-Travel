class Start extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.bitmapText(700, 170, 'Game3Font', 'Welcome to the game Dimention Travel!', 64).setOrigin(0.5);
        ...
        this.add.bitmapText(700, 600, 'Game3Font', 'Press enter to play', 70).setOrigin(0.5);
